...
def connect_via_jump(jump_host, jump_user, jump_key_path, target_host, target_user, target_password, target_key_path):
    try:
        ...
        if str(target_user) != 'nan':
            ...
            print(target_host + " has been connected:")
        else:
        ...
        for server in servers:
            ...
            try:
                ...
                if target_client:
                    ...
                    # print("cat /etc/auto.nfs_auto_share: ")
                    # out_file.write(f"服务器: {target_host}\n")
                    # out_file.write(result + '\n\n')
                    # print(result)
                    result = execute_command(target_client, "sudo df -h | grep -E 'app-data|vgdata-data'")
                    print("sudo df -h | grep 206:")
                    out_file.write(result + '\n\n')
                    print(result)
